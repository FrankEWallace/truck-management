  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        ...
        <button onClick={markAllRead} className="flex items-center gap-2 bg-card border border-border text-foreground px-4 py-2 rounded-lg text-sm font-medium hover:bg-muted transition-colors">
      ...
      <div className="space-y-2">
        {filtered.map((alert) => {
          ...
          return (
            <div key={alert.id} className={`bg-card border rounded-xl p-4 transition-colors ${!alert.read ? "border-primary/30 bg-primary/[0.02]" : "border-border"}`}>
